...
export const CATEGORIES = [
  ...
  { id: 'retail', name: 'RETAIL SEGMENT' },
  { id: 'residential', name: 'RESIDENTIAL SEGMENT' },
  { id: 'corporate', name: 'CORPORATE SEGMENT' },
  { id: 'edtech', name: 'EDTECH SEGMENT' },
  { id: 'healthcare', name: 'HEALTHCARE SEGMENT' }
];